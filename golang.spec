...
%global go_commit  0dd7b8f879a517e9a4cb9113c27f803df3d4fb07
%global go_shortcommit %(c=%{go_commit}; echo ${c:0:7})

Name:           golang
Version:        1.9
Release:        0.9git%{go_shortcommit}%{?dist}
...
%changelog
* Wed May 03 2017 Jakub Čajka <jcajka@redhat.com> - 1.9-0.9git0dd7b8f
- bump to 0dd7b8f879a517e9a4cb9113c27f803df3d4fb07
...
* Fri Feb 10 2017 Jakub Čajka <jcajka@redhat.com> - 1.9-0.3git3a20928
- bump to 3a20928157356f98db74db859b36d744400fc462

* Wed Feb 08 2017 Jakub Čajka <jcajka@redhat.com> - 1.9-0.2gite410d2a
- bump to e410d2a81ef26d7dcef0c712b584d2345b15148e 
...
* Tue Dec 06 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.27git10f43a1
- rebase to 10f43a1f4f889795ab2ed2916199ee96459ff6a3

* Mon Nov 28 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.26git25a81e7
- rebase to 25a81e77c22af89cb40f374e77167f0efb3fd95e

* Thu Nov 24 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.25gita2bd5c5
- rebase a2bd5c5563261309cb14a7f233d9fc89a2873c8a
...
* Thu Oct 27 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.19git0d17662
- rebase to 0d176621d925915152b7b0b332e553b6f0d635e2

* Tue Oct 25 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.18git80a0346
- rebase to 80a034642e9eac3fde60dbff920a70c4aae7fbc9

* Mon Oct 24 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.17git9ac6018
- rebase to 9ac60181e2e54b6404e67852d6e1e65a8cbd3616

* Tue Oct 18 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.16gitfaf882d
-rebase to faf882d1d427e8c8a9a1be00d8ddcab81d1e848e

* Mon Oct 17 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.15git99df54f
- rebase to 99df54f19696e26bea8d6a052d8d91ddb1e4ea65

* Fri Oct 14 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.14gitd13fa4d
- rebase to d13fa4d2256d6dfd030c03a82db258872e3e646c

* Wed Oct 12 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.13gitf373bf1
- rebase to f373bf1eb9a21f843dc0094c3702c2855a2e0d3f

* Mon Oct 10 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.12git795289b
- rebase to 795289b114e4dd4f69eaa7f74cb9eb7b6f963fff

* Fri Oct 07 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.11git0db9518
- rebase to 0db9518ab30f35c7c185aed337037e8305a98b34

* Mon Oct 03 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.10git9984195
- rebase to 998419575fb34dd5228cfdb353a73184e29db8da

* Thu Sep 29 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.9git03a1dc3
- rebase to 03a1dc3522f99bf5045fc41730e6682c1cc7402a

* Fri Sep 23 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.8gited915ad
- rebase to ed915ad421e61c3158ccae4bfbbcfbc796514ee2

* Mon Sep 19 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.7git6129f37
- rebase to 6129f37367686edf7c2732fbb5300d5f28203743

* Thu Sep 15 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.6git78c4658
- rebase to 78c46581f4da82473f3efcbbe1f3b48625f88471

* Mon Sep 12 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.5git8086e7c
- rebase to 8086e7c6ab85646cd53d5cb6d6183750a76e6214

* Mon Sep 05 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.4gitd588864
- rebase to d58886409398abfa1a3aed1864e9ee14d516c089

* Fri Sep 02 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.3git82bc0d4
- reabse to 82bc0d4e80870f25805029ef0e1e844ace7bf068

* Tue Aug 30 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.2gitadb1e67
- rebase to adb1e67f02fa58b13d1baf60c84556f375f6ceeb

* Thu Aug 25 2016 Jakub Čajka <jcajka@redhat.com> - 1.8-0.1gitf29ec7d
- move to 1.8 dev
- rebase to f29ec7d74a17249b3dfa721fc6ee1dcf3c77b5d5
